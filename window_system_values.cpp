...
namespace Calculator {
    ...
    double WindowSizes::getServiceCost() {
        return serviceCost;
    }
    ...
    double NumberOfOpenings::getServiceCost() {
        return serviceCost;
    }
    ...
    double Lamination::getServiceCost() {
        return serviceCost;
    }
    ...
    double DoubleGlazing::getServiceCost() {
        return serviceCost;
    }
    ...
    double BulkToning::getServiceCost() {
        return serviceCost;
    }
    ...
    double MosquitoNet::getServiceCost() {
        return serviceCost;
    }
