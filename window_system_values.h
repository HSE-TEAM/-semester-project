...
namespace Calculator {
    ...
    public:
        ...
        WindowSizes(double &square, double price, double &summaryCost) : square(&square), price(price),
    ...
    public:
        ...
        Toning(WindowSizes &windowSizes, double &summaryCost, double price) : windowSizes(&windowSizes),
                                                                              summaryCost(&summaryCost),
                                                                              price(price) {};
    ...
    public:
        ...
        BulkToning(WindowSizes &windowSizes, double &summaryCost) : windowSizes(&windowSizes),
                                                                    summaryCost(&summaryCost) {};
    ...
    public:
        ...
        Triplex(WindowSizes &windowSizes, double &summaryCost) : windowSizes(&windowSizes),
                                                                 summaryCost(&summaryCost) {};
